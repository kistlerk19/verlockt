  ...
  <div class="p-4 mb-3 bg-gray-100 border rounded-md shadow">
    ...
    <div class="grid grid-cols-2 gap-3 mb-3 lg:grid-cols-3">
      <template v-for="attachment of post.attachments" :key="attachment.id">
        ...
        >
        <!-- download -->
          <button class="absolute flex items-center justify-center w-8 h-8 text-gray-100 transition-all bg-gray-400 rounded opacity-0 cursor-pointer group-hover:opacity-100 hover:bg-gray-700 top-2 right-2">
          <svg
    ...
    <div class="flex gap-2 text-gray-700">
      <button class="flex items-center justify-center flex-1 gap-1 px-4 py-2 bg-gray-100 rounded-full hover:bg-gray-200">
